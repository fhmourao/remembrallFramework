/************************************************************************
                        retriveObviousItems.cpp
************************************************************************/

#include "retriveObviousItems.h"
...
int main(int argc, char **argv){
	...
	while( !testFile.eof() ){
		...
		recommendForgottenItems(testMoment, forgottenItems, contextSize, trainingData, currentUser, itemsSimilarity, ((int) percentageOfHistory));
